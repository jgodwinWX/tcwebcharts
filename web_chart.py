...
atcf_file = ['/home/jgodwin/python/web_tracking_chart/bal042019.csv',\
    '/home/jgodwin/python/web_tracking_chart/bal982019.csv']
# if namedStorm is set to True, the invest portion of the track will be ommitted
namedStorm = [True,False]
savename = '/var/www/html/images/tracking_chart.png'
...
# save the figure
plt.savefig('%s' % savename, orientation='landscape', bbox_inches='tight')
print('Great success!')
